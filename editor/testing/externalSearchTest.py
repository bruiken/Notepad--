...
class ExternalSearchTest(unittest.TestCase):
    def testSearch(self):
        ...
        self.assertEqual(google,"https://www.google.com/search?q=diff&gws_rd=ssl")
        #self.assertEqual(stack,"https://stackoverflow.com/nocaptcha?s=271f432a-4de7-4b0d-9cab-b40bd0544221")
        self.assertEqual(youtube,"https://www.youtube.com/results?search_query=diff")
